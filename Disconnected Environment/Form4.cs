...
namespace Disconnected_Environment
{
    public partial class Form4 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'universityDataSet.status_mahasiswa' table. You can move, or remove it, as needed.
            this.status_mahasiswaTableAdapter.Fill(this.universityDataSet.status_mahasiswa);
