...
namespace Disconnected_Environment
{
    public partial class Form3 : Form
    {
        ...
        public Form3()
        {
            ...
            this.mahasiswaBindingSource = this.customersBindingSource;
            refreshform();
        }
        ...
        {
            // TODO: This line of code loads data into the 'universityDataSet.Mahasiswa' table. You can move, or remove it, as needed.
            this.mahasiswaTableAdapter.Fill(this.universityDataSet.Mahasiswa);
            this.mahasiswaTableAdapter.Fill(this.universityDataSet.Mahasiswa);
            koneksi.Open();
